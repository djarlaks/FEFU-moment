...
void BreadthFirstSearch(const Graph& graph, const Vertex& origin_vertex,
                        Visitor visitor) {
...
int main() {
...

  {
    ...
    if (visitor.DistanceTo(1) != 1 || visitor.DistanceTo(2) != 2 ||
        visitor.DistanceTo(3) != 3 || visitor.Parent(0) != 0 ||
        visitor.Parent(1) != 0 || visitor.Parent(2) != 1 ||
        visitor.Parent(3) != 2 || false) {
      std::cout << __LINE__ << "\n";
      fail();
    }
  }

  {
    ...
    BfsVisitor<int> visitor;
    BreadthFirstSearch(graph, 0, visitor);
    if (visitor.DistanceTo(1) != 1 || visitor.DistanceTo(2) != 1 ||
        visitor.Parent(1) != 0 || visitor.Parent(2) != 0 || false) {
      std::cout << __LINE__ << "\n";
      fail();
    }
  }

  {
    ...
    BreadthFirstSearch(graph, 0, visitor);
    if (visitor.DistanceTo(1) != 1 || visitor.DistanceTo(2) != 1 ||
        visitor.DistanceTo(3) != 1 || visitor.DistanceTo(4) != 2 ||
        visitor.DistanceTo(5) != 2 || visitor.DistanceTo(6) != 3 ||
        visitor.DistanceTo(7) != 1 || visitor.DistanceTo(8) != 2 ||
        visitor.DistanceTo(9) != 3 || visitor.DistanceTo(10) != 4 ||
        visitor.DistanceTo(11) != 4 || visitor.DistanceTo(12) != 4 ||
        visitor.DistanceTo(13) != 4 || visitor.DistanceTo(14) != 4 ||
        visitor.Parent(1) != 0 || visitor.Parent(2) != 0 ||
        visitor.Parent(3) != 0 || visitor.Parent(7) != 0 ||
        visitor.Parent(4) != 3 || visitor.Parent(5) != 3 ||
        visitor.Parent(11) != 6 || visitor.Parent(8) != 7 ||
        visitor.Parent(9) != 8 || visitor.Parent(10) != 9 || false) {
      std::cout << __LINE__ << "\n";
      fail();
    }
  }
