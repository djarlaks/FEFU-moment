...
using SmartPointer__another_type_t =
    SmartPointer<uint64_t, std::allocator<uint64_t>>;
...
DEFINE_CLASS_TESTS(SmartPointer__type_t) {
  ...
  TEST_BLOCK(
      "SmartPointer[non-nullptr]::operator=(const SmartPointer[nullptr]&)") {
    auto raw_ptr = new SmartPointer__type_t::value_type;
  ...
  TEST_BLOCK(
      "SmartPointer[nullptr]::operator=(const SmartPointer[non-nullptr]&)") {
    auto raw_ptr = new SmartPointer__type_t::value_type;
  ...
  TEST_BLOCK(
      "SmartPointer[non-nullptr]::operator=(const "
      "SmartPointer[non-nullptr]&)") {
  ...
  TEST_BLOCK(
      "[same] SmartPointer[non-nullptr]::operator=(const "
      "SmartPointer[non-nullptr]&)") {
    auto raw_ptr1 = new SmartPointer__type_t::value_type;
    auto raw_ptr2 = new SmartPointer__type_t::value_type;
    SmartPointer__type_t sptr1(raw_ptr1), sptr2(raw_ptr2);
  ...
  TEST_BLOCK(
      "SmartPointer[non-nullptr]::operator=(SmartPointer[non-nullptr]&&)") {
    auto raw_ptr1 = new SmartPointer__type_t::value_type;
    auto raw_ptr2 = new SmartPointer__type_t::value_type;
    SmartPointer__type_t sptr1(raw_ptr1), sptr2(raw_ptr2);
  ...
  TEST_BLOCK("SmartPointer[nullptr]::operator*()") {
    SmartPointer__type_t sptr;
    CHECK_THROW_WITH_TYPE_TRAIT(*sptr = SmartPointer__type_t::value_type(),
                                smart_pointer::exception);
  }
  ...
  __stress_tests__SmartPointer_operator_star<SmartPointer__type_t::value_type>(
      classname);
  ...
  // operator==
  TEST_BLOCK(
      "[same types] SmartPointer[nullptr]::operator==(const "
      "SmartPointer[nullptr]&) const") {
    SmartPointer__type_t sptr1, sptr2;
    ASSERT(sptr1 == sptr2);
  }

  TEST_BLOCK(
      "[not same types] SmartPointer[nullptr]::operator==(const "
      "SmartPointer[nullptr]&) const") {
  ...
  TEST_BLOCK(
      "[same types] SmartPointer[non-nullptr]::operator==(const "
      "SmartPointer[nullptr]&) const") {
  ...
  TEST_BLOCK(
      "[not same types] SmartPointer[non-nullptr]::operator==(const "
      "SmartPointer[nullptr]&) const") {
    SmartPointer__type_t sptr1(new SmartPointer__type_t::value_type);
    SmartPointer__another_type_t sptr2;
    ASSERT(!(sptr1 == sptr2));
  ...
  TEST_BLOCK(
      "[same types] SmartPointer[nullptr]::operator==(const "
      "SmartPointer[non-nullptr]&) const") {
  ...
  TEST_BLOCK(
    ...
    SmartPointer__type_t sptr1;
    SmartPointer__another_type_t sptr2(
        new SmartPointer__another_type_t::value_type);
    ASSERT(!(sptr1 == sptr2));
  }

  TEST_BLOCK(
      "[same types & ptrs] SmartPointer[non-nullptr]::operator==(const "
      "SmartPointer[non-nullptr]&) const") {
    SmartPointer__type_t sptr1(new SmartPointer__type_t::value_type),
        sptr2(sptr1);
    ASSERT(sptr1 == sptr2);
  ...
  TEST_BLOCK(
      "[same types & not same ptrs] "
      "SmartPointer[non-nullptr]::operator==(const SmartPointer[non-nullptr]&) "
      "const") {
    SmartPointer__type_t sptr1(new SmartPointer__type_t::value_type),
        sptr2(new SmartPointer__type_t::value_type);
    ASSERT(!(sptr1 == sptr2));
  }

  TEST_BLOCK(
      "[not same types & not same ptrs] "
      "SmartPointer[non-nullptr]::operator==(const SmartPointer[non-nullptr]&) "
      "const") {
    SmartPointer__type_t sptr1(new SmartPointer__type_t::value_type);
    SmartPointer__another_type_t sptr2(
